...
$critical_count_arr = [2];
$high_count_arr = [2];
$medium_count_arr = [2];
$low_count_arr = [2];
$none_count_arr = [2];
$duplicate_count_arr = [2];
...
$graph->xaxis->SetTickLabels(['Open', 'Resolved', 'Closed']);
...
$gbarplot = new GroupBarPlot([$bplot1, $bplot2, $bplot3, $bplot4, $bplot5, $bplot6]);
