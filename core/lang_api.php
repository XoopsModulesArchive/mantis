...
function lang_load($p_lang)
{
    ...
    $t_lang_dir = dirname(__DIR__) . DIRECTORY_SEPARATOR . 'lang' . DIRECTORY_SEPARATOR;
    ...
    $t_custom_strings = dirname(__DIR__) . DIRECTORY_SEPARATOR . 'custom_strings_inc.php';
...
{
    // RMV FIXME: why is cookie needed here?  Can't we just make

    // sure user is authenticated??
    ...
    */
    ...
    if (db_is_connected() && auth_is_user_authenticated()) {
