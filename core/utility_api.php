...
# --------------------------------------------------------
# $Id: utility_api.php,v 1.7 2003/02/20 13:19:29 vboctor Exp $
# --------------------------------------------------------
...
function mime_encode($p_string = '')
{
    ...
    for ($i = 0, $iMax = mb_strlen($p_string); $i < $iMax; $i++) {
...
{
    if ($p_path && DIRECTORY_SEPARATOR != $p_path[mb_strlen($p_path) - 1]) {
