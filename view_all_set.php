...
$fHandler_id = gpc_get_string('handler_id', '');
# sort direction
...
switch ($f_type) {
    # New cookie
    case '0':
        $t_settings_string = (string)$t_cookie_version
                             . '#any#any' . "#any#$f_per_page" . "#$t_default_show_changed#$t_hide_closed_default" . '#any#any' . '#last_updated#DESC' . "#$f_start_month#$f_start_day" . "#$f_start_year#$f_end_month" . "#$f_end_day#$f_end_year" . "#$f_search#$f_hide_resolved";
        break;
    # Update filters
    case '1':
        $t_settings_string = (string)$t_cookie_version
    ...
    case '2':
        $t_settings_string = (string)$t_setting_arr[0]
